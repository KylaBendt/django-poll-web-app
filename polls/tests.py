...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        ...
        future_question = Question(question_text="What does the future look like?", pub_date=time)
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() returns False for questions
        whose pub_date is greater than 1 day in the past
        """
        time = timezone.now() - datetime.timedelta(days=1, seconds=1)
        old_question = Question(question_text="How old are you?", pub_date=time)
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        whose pub_date is in the previous day
        """
        time = timezone.now()
        recent_question = Question(question_text="What do you want to do now?", pub_date=time)
